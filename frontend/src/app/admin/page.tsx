...
export default function Admin() {
    ...
    const [userData, setUserData] = useState<{name:String, email:String, id:String,  date:String, dob:String, account_created:String, type:String, payment_method:String}[]>([]);
                ...
                <div className="h-full m-8 drop-shadow-xl rounded-md bg-gray-100 py-4 px-4">
                    <div className='flex flex-wrap gap-2 md:gap-4 mb-6 md:mb-10'>
                        ...
                        <div className='justify-self-end'>
                            ...
                            <Button className="bg-primary rounded-full items-center" onClick={open}>Add Admin User <FiPlus className="ml-2" size={20}/></Button>
                        </div>
                    </div>
                        ...
                        {filter && (method || type) ? (
                            <tbody className="shad-text-gray-500 dark:shad-text-gray-400 text-sm">
                                {userData && userData.map((data) => {
                                    ...
                                    if (renderRow) {
                                        return (
                                            <tr className="border-b hover:shad-bg-gray-100 dark:hover:shad-bg-gray-800" key={data.email}>
                                                ...
                                                <td className="px-4 py-3">
                                                    <Button variant="default" onClick={() => remove(data.id)}>Remove User</Button>
                                                </td>
                                            </tr>
                                        );
                                    }
