...
class TestFriendshipRoutes:
    ...
    def test_send_friend_request_success(self, client, clean_db):
        ...
        token2, id2 = imports.users.user2(self, client, clean_db)
        ...
        friend_request = imports.models.Friendship.query.filter_by(requester_id=id, addressee_id=id2).first()
    ...
    def test_accept_friend_request_success(self, client, clean_db):
        ...
        friendship_request = imports.models.Friendship(requester_id=id, addressee_id=id2)
        ...
        updated_friend_request = imports.models.Friendship.query.filter_by(requester_id=id, addressee_id=id2).first()
    ...
    def test_list_pending_friend_requests(self, client, clean_db):
        ...
        friendship_request = imports.models.Friendship(requester_id=id, addressee_id=id2, status="pending")
        clean_db.session.add(friendship_request)
        clean_db.session.commit()
    ...
    def test_list_friends(self, client, clean_db):
        ...
        token, id, token2, id2 = imports.users.user1(self, client, clean_db)
